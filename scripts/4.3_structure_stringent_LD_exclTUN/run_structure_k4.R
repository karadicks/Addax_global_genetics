...
setwd("/mnt/profiles/kdicks/3.WG_Projects/WG1705_ADX/2021_ADX_paper_analysis/4.analysis/3.structure_1704_exTUN/")
...
infile <- "1.input_files/ADX_geno95_exTun.recode.strct_in"
